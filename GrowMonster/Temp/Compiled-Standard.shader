...
//
  ...
  78: sample_l r7.xyzw, r7.xyzx, t4.xyzw, s0, r2.w
 ...
 100:   endif 
 101:   sample_l r9.xyzw, r5.xyzx, t5.xyzw, s0, r2.w
 ...
 175: mad r0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
 176: sample r1.xyzw, v1.xyxx, t3.xyzw, s4
 177: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
...
//
 ...
 136:   endif 
 137:   sample_l r4.xyzw, r6.xyzx, t5.xyzw, s0, r2.w
 ...
 190: mul r2.x, r3.x, r5.y
 191: mad r2.x, -r2.x, l(0.280000), l(1.000000)
 192: dp3 r2.w, r0.xyzx, r0.xyzx
 193: ne r2.w, r2.w, l(0.000000)
 194: and r2.w, r2.w, l(0x3f800000)
 195: mul r1.w, r1.w, r2.w
 196: add r0.w, -r0.w, cb0[8].w
 197: add_sat r0.w, r0.w, l(1.000000)
 ...
 212: mad r0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
 213: sample r1.xyzw, v1.xyxx, t3.xyzw, s4
 214: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
...
// Approximately 0 instruction slots used
 ...
 // Stats for Fragment shader:
 //        d3d11: 32 avg math (11..43), 4 avg texture (2..6), 1 avg branch (0..2)
 Pass {
  Name "DEFERRED"
...
SubShader { 
 ...
 // Stats for Fragment shader:
 //        d3d11: 107 avg math (50..177), 5 avg texture (4..8), 4 avg branch (2..8)
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="FORWARDBASE" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "PerformanceChecks"="False" }
  ZWrite [_ZWrite]
...
-- Fragment shader for "d3d11":
// Stats: 50 math, 7 temp registers, 4 textures, 2 branches
...
//
  ...
  51: mul r2.yz, r6.xxyx, r6.xxyx
  52: mul r4.yz, r2.yyzy, r2.yyzy
  53: add r1.w, -r0.w, cb0[8].w
  54: add_sat r1.w, r1.w, l(1.000000)
  55: sample r6.xyzw, r4.ywyy, t2.xyzw, s2
  56: mul r2.y, r6.x, l(16.000000)
  57: mul r2.yzw, r0.xxyz, r2.yyyy
  58: mad r1.xyz, r1.xyzx, r0.wwww, r2.yzwy
  59: mul r2.xyz, r2.xxxx, r5.xyzx
  60: add r4.xyw, -r0.xyxz, r1.wwww
  61: mad r0.xyz, r4.zzzz, r4.xywx, r0.xyzx
  62: mul r0.xyz, r0.xyzx, r3.xyzx
  63: mad o0.xyz, r1.xyzx, r2.xyzx, r0.xyzx
...
-- Fragment shader for "d3d11":
// Stats: 53 math, 8 temp registers, 5 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 4
Set 2D Texture "unity_NHxRoughness" to slot 2
...
//
  ...
  66: sample r1.xyzw, v1.xyxx, t3.xyzw, s5
  67: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
...
-- Fragment shader for "d3d11":
// Stats: 51 math, 7 temp registers, 5 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 4
Set 2D Texture "unity_NHxRoughness" to slot 2
Set 2D Texture "_EmissionMap" to slot 3 sampler slot 5
...
//
  ...
  61: mad r0.xyz, r4.zzzz, r4.xywx, r0.xyzx
  62: mul r0.xyz, r0.xyzx, r3.xyzx
  63: mad r0.xyz, r1.xyzx, r2.xyzx, r0.xyzx
  64: sample r1.xyzw, v1.xyxx, t3.xyzw, s5
  65: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
  66: mov o0.w, l(1.000000)
  67: ret 
// Approximately 0 instruction slots used
